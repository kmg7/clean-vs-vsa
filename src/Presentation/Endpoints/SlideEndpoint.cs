...
using Commands = Application.Slides.Commands;
using Entities = Application.Slides.Entities;
using Queries = Application.Slides.Queries;
...
public static class SlideEndpoints
{
    public static WebApplication MapSlideEndpoints(this WebApplication app)
    {
        ...
        _ = presentationGroup.MapPost("/", CreateSlide)
            .Produces<Entities.Slide>(StatusCodes.Status201Created)
            .ProducesProblem(StatusCodes.Status500InternalServerError)
